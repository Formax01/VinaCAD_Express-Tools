...
namespace Tools.View.Behaviors
{
    public class FilterableComboBox : ComboBox
    {
        ...
        /// </summary>
        public 
            Action<FilterableComboBox, object> SelectionEffectivelyChanged;
        ...
        /// <summary>
        /// Kiểm tra xem item có chứa text nhập vào để filter hay không
        /// Chú ý các item (class) cần overide ToString() theo đúng tên hiển thị trên combobox
        /// </summary>
