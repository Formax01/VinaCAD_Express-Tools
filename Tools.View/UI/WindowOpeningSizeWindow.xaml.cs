...
{
    public partial class WindowOpeningSizeWindow : Window
    {
        ...
        public bool PickExistingWindowWidthRequested { get; private set; }

        public WindowOpeningSizeWindow(
            ...
            double defaultWallThickness)
        {
            ...
            double windowHeight = initialSelection?.Height > 0 ? initialSelection.Height : defaultHeight;
        ...
        private void PickExistingWindowWidth_Click(object sender, RoutedEventArgs e)
        {
            CaptureCurrentValues();
            PickExistingWindowWidthRequested = true;
            DialogResult = true;
        }
        ...
        private void Accept_Click(object sender, RoutedEventArgs e)
        {
            if (!TryParse(HoleWidthText.Text, out double holeWidth) || holeWidth <= 0)
            {
                ShowValidation("Chiều rộng lỗ cửa sổ phải là số lớn hơn 0.");
                return;
            }
            double pierWidth = 0;
